...
We do not place volunteers in organisations (that is your connection to make), but we can verify registration status and advise on the visa documentation that specific organisations need to provide. See our [volunteer visa Chiang Mai guide](/volunteer-visa-chiang-mai/) for the full application process.
