...
**What happens if circumstances change, say, a parent gets a job after starting on a guardian visa?** You can transition between categories as your family's situation changes; we advise on the right timing and process when that happens. See our [guardian visa Chiang Mai service](/guardian-visa-chiang-mai/) page for the complete guardian visa requirements.

**Where can I find the full guardian visa eligibility criteria?** See our [guide to guardian visas in Thailand](/guardian-visa-thailand-requirements/) for who qualifies, the financial threshold, and the step-by-step application process.
