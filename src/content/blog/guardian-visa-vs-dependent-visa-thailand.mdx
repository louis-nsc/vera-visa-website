...
| Financial threshold | 400,000 THB in a Thai bank account, or 40,000 THB monthly provable income | Depends on the primary holder's visa category |
| Work allowed | No | No |
...
The guardian visa's threshold (400,000 THB, or 40,000 THB/month) is independent of any other family member's finances. Dependent visa requirements instead flow from whatever the primary visa holder's category requires — there's no separate dependent-specific threshold to calculate.
