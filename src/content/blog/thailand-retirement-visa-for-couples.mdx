...
**What happens at renewal if our financial situation changes?** You can adjust which method each partner uses between renewals. See our [retirement visa financial requirements guide](/thailand-retirement-visa-financial-requirements/) for the full comparison of methods available, and our [retirement visa Chiang Mai guide](/retirement-visa-chiang-mai/) for full application support.

**Does this work if one partner is American?** Yes, nationality doesn't affect the couples structure itself, only the income documentation each partner provides. See our guide on [how to retire in Thailand from the USA](/how-to-retire-in-thailand-from-usa/) for the American-specific documentation.

Planning to retire together? [Chat with us on WhatsApp](https://wa.me/66908917582) and we'll map out the right visa route for both of you.
