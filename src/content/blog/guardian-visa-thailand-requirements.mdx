...
## What happens to the second parent?

Only one parent or guardian can hold the guardian visa for a given child. The second parent needs an alternative visa basis: marriage visa (if married to a Thai national), retirement visa (if eligible), or DTV (if they have qualifying remote income). There's no restriction on both parents living in Thailand together — each simply needs their own valid visa category.
...
**Can both parents get guardian visas for the same child?** Typically, only one guardian visa is issued per child; the second parent needs an alternative visa basis (marriage visa if married to a Thai national, retirement visa if eligible, or DTV if they have qualifying remote income). This varies by case and immigration office. See our [guardian visa Chiang Mai service](/guardian-visa-chiang-mai/) page or contact us to discuss your family's specific situation.
